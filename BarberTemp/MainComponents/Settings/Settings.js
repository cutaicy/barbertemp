...
var Welcome = require('../Welcome/Authenticate')
...
class Settings extends Component {
  ...
  goToWelcome() {
    ...
    this.props.navigator.popToRoute(routes[0])
  }
            ...
            <View style = {{flex: 1, marginTop: 68}}>
              ...
              <TouchableHighlight
                ...
                onPress={this.goToHome.bind(this)}>
                  <View style = {{flex: 1, borderColor: 'white', borderWidth: 1, padding: 16, marginLeft: 16, marginRight: 16, marginBottom: 84}}>
                    <Text style = {{color: 'white', textAlign: 'center', fontSize: 16, fontFamily: 'Calibri'}}>SAVE</Text>
                  </View>
              </TouchableHighlight>
              <TouchableHighlight
                underlayColor = 'transparent'
                onPress={this.goToWelcome.bind(this)}>
                  <View style = {{flex: 1, borderColor: 'white', borderWidth: 1, padding: 16, marginLeft: 16, marginRight: 16}}>
                    <Text style = {{color: 'white', textAlign: 'center', fontSize: 16, fontFamily: 'Calibri'}}>LOG OUT</Text>
                  </View>
              </TouchableHighlight>
            </View>
          </View>
